...
public class CustomerRegistrationController {
	...
	public Mono<Customer> registerCustomer(@RequestBody Customer customer) throws URISyntaxException {
		return customerRegistrationService.registerCustomer(customer)
				.doOnSuccess(cus -> log.info("Customer registered: accountno", cus.getAccountno()));
	}
